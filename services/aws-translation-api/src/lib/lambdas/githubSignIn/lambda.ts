...
export class GithubSignInLambda extends nodeLambda.NodejsFunction {
  constructor(scope: cdk.Stack, lambdaEnv: AWS.LambdasProps, logGroup?: cdk.aws_logs.LogGroup) {
    const params: nodeLambda.NodejsFunctionProps = {
      ...
      handler: 'handler',
      functionName: resourceNames.githubSignInLambda,
    ...
    super(scope, resourceNames.githubSignInLambda, params);
  }
}
